 ...
 * @version 04/20/2019
 */
public class PercentRegion implements Comparator<String> {
         ...
         */
        public void increment(String region, String hasHeard, String hasLiked) {
            heard(region, hasHeard);
            liked(region, hasLiked);
        }
        ...
        private void heard(String region, String answer) {
            if (answer == "Yes") {
                if (region == "Northeast US") {
                    heard[0][1]++;
                }
                else if (region == "Southeast US") {
                    heard[1][1]++;
                }
                else if (region == "the rest of US") {
                    heard[2][1]++;
                }
                else if (region == "outside the US") {
                    heard[3][1]++;
                }
            }
            else if (answer == "No") {
         ...
         *            answer to like or not
         */
        private void liked(String region, String answer) {
            if (answer == "Yes") {
                if (region == "Northeast US") {
                    heard[0][1]++;
                }
